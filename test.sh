...
assert 2 '{ if (1) { if (2) return 2; else return 3; } return 4; }'
assert 3 '{ if (1) { if (0) return 2; else return 3; } return 4; }'
assert 4 '{ if (0) { if (0) return 2; else return 3; } return 4; }'
...
assert 3 '{ int i=0; for (;;) { return 3; } return 5; }'
...
assert 2 '{ int x=1; int y=3; int z=5; return &z - &x; }'
